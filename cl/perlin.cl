...
__constant int perlin[] = { 151,160,137,91,90,15,
...
//	init_perlin(perlin);
	...
	w = fade(z);
	int A = perlin[X] + Y,									// HASH COORDINATES OF
	AA = perlin[A] + Z,										// THE 8 CUBE CORNERS,
	AB = perlin[A + 1] + Z, 
	B = perlin[X + 1] + Y, 
	BA = perlin[B] + Z, 
	BB = perlin[B + 1] + Z;
	return 
	(lerp(w, lerp(v, lerp(u, grad(perlin[AA], x, y, z),		// AND ADD  
